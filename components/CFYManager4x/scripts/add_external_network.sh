...
sudo /opt/mgmtworker/env/bin/python /opt/cloudify/manager-ip-setter/create-internal-ssl-certs.py --metadata /etc/cloudify/ssl/certificate_metadata $PRIVATE_IP
