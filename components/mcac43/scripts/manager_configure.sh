...
env -i cfy blueprints upload -n aws.yaml              -b "db-aws"        "https://github.com/cloudify-examples/mariadb-blueprint/archive/master.zip"  >> /tmp/cfy_status.txt 2>&1 &
env -i cfy blueprints upload -n aws.yaml              -b "lb-aws"        "https://github.com/cloudify-examples/haproxy-blueprint/archive/master.zip"  >> /tmp/cfy_status.txt 2>&1 &
